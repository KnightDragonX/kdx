...
export const summaryData: SummaryRow[] = [
  { channel: 'AI for Hackers', primaryVisual: 'AI Chat Screen', recordingFocus: 'Prompt → Response → Terminal Test', bRollNeeded: 'Light cybersecurity (Pexels/Pixabay)', videoLength: '5-8 min' },
  { channel: 'BlackArch Arsenal', primaryVisual: 'Terminal', recordingFocus: 'Commands + Output (tool demo)', bRollNeeded: 'Minimal', videoLength: '6-10 min' },
  { channel: 'CTF Solved', primaryVisual: 'Full Desktop', recordingFocus: 'Walkthrough (Enum → Exploit → Privesc → Flag)', bRollNeeded: 'None', videoLength: '8-15 min' },
  { channel: 'CVE Explained', primaryVisual: 'Stock Footage', recordingFocus: 'Voiceover + Diagrams + Graphics', bRollNeeded: 'Heavy (Pexels/Pixabay/Mixkit)', videoLength: '3-5 min' },
  { channel: 'AI Builds', primaryVisual: 'AI Chat + Browser', recordingFocus: 'Code generation + Live testing', bRollNeeded: 'Minimal', videoLength: '6-10 min' },
  { channel: 'Arch Security Lab', primaryVisual: 'Terminal', recordingFocus: 'Commands + Config + Verification', bRollNeeded: 'None', videoLength: '5-8 min' },
]

export function getAllVideoPlans() {
